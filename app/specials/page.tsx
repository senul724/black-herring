...
//   head: () => ({
//     meta: [
//       { title: "Chef's Specials — Black Herring" },
//       { name: "description", content: "Limited weekly specials and signature plates from the Black Herring kitchen and bar." },
//       { property: "og:title", content: "Chef's Specials — Black Herring" },
