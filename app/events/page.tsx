...
// 	head: () => ({
// 		meta: [
// 			{ title: "Events & Private Dining — Black Herring" },
// 			{
// 				name: "description",
// 				content:
// 					"Host birthdays, bachelor parties, anniversaries, corporate gatherings and more at Black Herring. Free BYOB, private rooms with karaoke, live music every night.",
// 			},
// 			{ property: "og:title", content: "Events at Black Herring" },
// 			{
			...
			<section className="relative pt-40 pb-24 px-6 overflow-hidden border-b border-border">
				...
				<div className="relative max-w-7xl mx-auto">
					...
					<h1 className="font-display text-6xl md:text-8xl leading-none">
						Celebrate <span className="italic text-primary">at Black Herring</span>.
					</h1>
					...
					<div className="mt-10 flex flex-wrap gap-4">
						...
						>
							Enquire +1 (305) 555-0188
						</a>
						<a
							href="mailto:hello@blackherring.com"
				...
				<div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-16 items-center">
					<div>
						...
						<p className="text-muted-foreground leading-relaxed mb-5">
							Welcome to Black Herring — Miami Beach's best BYOB restaurant at
							450 Ocean Drive, Miami Beach, FL 33139. Whether you're planning a private dining
						...
						<p className="text-muted-foreground leading-relaxed">
							...
							Private rooms tailored to every event. Restaurants in Miami Beach
