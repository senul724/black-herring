...
//   head: () => ({
//     meta: [
//       { title: "Menu — Black Herring" },
//       { name: "description", content: "Explore the full menu at Black Herring — burgers, bowls, Sri Lankan mains, signature tilapia, cocktails and more." },
//       { property: "og:title", content: "Menu — Black Herring" },
								...
								>
									...
									<div className="flex items-start">
										<span className="font-sans text-lg text-primary whitespace-nowrap">
											{it.price.startsWith("$") ? it.price : `$${it.price}`}
										</span>
									</div>
								</li>
							))}
