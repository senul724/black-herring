...
// 	head: () => ({
// 		meta: [
// 			{ title: "Gallery — Black Herring" },
// 			{
// 				name: "description",
// 				content:
// 					"Inside Black Herring — interiors, signature plates, cocktails and the live music nights at Race Course, Colombo 07.",
// 			},
// 			{ property: "og:title", content: "Gallery — Black Herring" },
// 			{
// 				property: "og:description",
// 				content: "Inside the room. Photos from Black Herring.",
// 			},
			...
			<section className="pt-40 pb-16 px-6 border-b border-border">
				<div className="max-w-7xl mx-auto">
					...
					<p className="mt-8 max-w-xl text-muted-foreground">
						Evenings at Ocean Drive. The room, the plates, the bar, the band. A
						small window into what waits for you at Black Herring.
					</p>
				</div>
			</section>
